...
trpred_lr = lr.predict(trX)
tepred_lr = lr.predict(teX)




""" NN (MLP) Regression Model """
...
trpred_mlp = mlp.predict(trX)
tepred_mlp = mlp.predict(teX)



plt.figure()
plt.plot(tepred_mlp, lw=1.5, label='Prediction' )
...
plt.figure()
plt.plot(trpred_mlp, lw=1.2, label='Prediction' )
...
""" Deep Neural Regression Model Using TensorFlow"""
